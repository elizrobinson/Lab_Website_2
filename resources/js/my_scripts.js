...
function loadStatsPage(){
	...
	for(row_counter = 2; row_counter < document.getElementById("stats_table").rows.length; row_counter++){
		if(parseInt(document.getElementById("stats_table").rows[row_counter].cells[2].innerHTML)< 
			parseInt(document.getElementById("stats_table").rows[row_counter].cells[3].innerHTML)){
			document.getElementById("stats_table").rows[row_counter].cells[4].innerHTML = 
			document.getElementById("stats_table").rows[row_counter].cells[1].innerHTML
			bufflosses ++
		}
		else{
			document.getElementById("stats_table").rows[row_counter].cells[4].innerHTML = 
...
function loadPlayersPage(){
	...
	for(var i = 0; i<players.length; i++){
		...
		// tags += '<button onclick="which_button(' +i +')">' +arr[i]+'</button><br/>'
		;
	}
...
function switchPlayers(playerNum){
	...
	document.getElementById("avg_rec_yards").innerHTML = players[playerNum].pass_yards / players[playerNum].games_played
}
